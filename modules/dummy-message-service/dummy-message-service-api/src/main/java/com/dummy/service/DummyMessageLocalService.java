...
/**
 * Provides the local service interface for DummyMessage. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see DummyMessageLocalServiceUtil
...
public interface DummyMessageLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link DummyMessageLocalServiceUtil} to access the dummy message local service. Add custom service methods to {@link com.dummy.service.impl.DummyMessageLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public DummyMessage createDummyMessage(long id);
	...
	*/
	...
	public DummyMessage deleteDummyMessage(DummyMessage dummyMessage);
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public DummyMessage deleteDummyMessage(long id) throws PortalException;
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public DummyMessage fetchDummyMessage(long id);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public DummyMessage getDummyMessage(long id) throws PortalException;
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<DummyMessage> getDummyMessages(int start, int end);
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public DummyMessage updateDummyMessage(DummyMessage dummyMessage);
}